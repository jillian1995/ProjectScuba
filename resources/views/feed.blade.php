    ...
    <div class="panel-body">
      <div class="media">
        ...
        <div class="media-body">
          <h4 id="profile_name" class="media-heading" id="profile_name">Ryan Beckett</h4>
      ...
      <div class="btn-group">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Dive Info</button>
      </div>
    </div>
</div>
